Input/Output
Project done during Full Stack Software Engineering studies at ALX SE. It aim is to learn how to open, read, write and append files from a script in Python.
