...
Project done during Full Stack Software Engineering studies at ALX SE. It aims to learn about how to connect to a MySQL database from a Python script, what ORM means and how to map a Python Class to a MySQL table.
